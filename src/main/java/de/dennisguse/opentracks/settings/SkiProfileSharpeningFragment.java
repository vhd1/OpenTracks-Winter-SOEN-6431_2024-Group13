...
public class SkiProfileSharpeningFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
        setPreferencesFromResource(R.xml.fragment_ski_profile_sharpening_info, rootKey);

        EditTextPreference waxingIntervalPreference = findPreference("sharpening_interval");
        ...
        Preference lastWaxingDatePreference = findPreference("last_sharpening_date");

        // Retrieve the last selected date from SharedPreferences
        SharedPreferences sharedPreferences = getPreferenceManager().getSharedPreferences();
        String lastSelectedDate = sharedPreferences.getString("last_sharpening_date", "");
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        editor.putString("last_sharpening_date", selectedDate);
                        editor.apply();
                    }
                },
